...
rule all:
    input: 
        ...
        sample_id+'.mm9.raw.bam',
        sample_id+'.mm9.raw.bam.bai',
        sample_id+'.mm9.bam',
        sample_id+'.mm9.bam.bai'
...
rule alignment:
    ...
    output:
        ...
        sample_id+'.mm9.bam.bai'
    params:
        ref='/gpfs/genomedb/other_species/mouse/GRCh38.75_plus_phage.fasta'
    threads:20
    log:
...
rule Frip:
    input:
        bed = 'qc.bed',
        peak = sample_id+'.macs2_BAMPE_peaks.narrowPeak'
    output:
        sample_id+'_Frip.tsv'
    threads:1
    log:
